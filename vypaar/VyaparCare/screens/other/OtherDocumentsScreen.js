...
export default function OtherDocumentsScreen({ navigation }) {
  ...
  const handleNext = () => {
    ...
    navigation.navigate('OtherAdditional');
  };
    ...
    <SafeAreaView style={styles.container} edges={['left', 'right']}>
      ...
      >
        <View style={styles.banner}>
          <Text style={styles.bannerTitle}>📁 Step 5: Dynamic Document Checklist</Text>
          <Text style={styles.bannerSubtitle}>
            Upload clear digital copies in PDF / JPG / PNG format. Document requirements are customized to your selected service.
          </Text>
        </View>
      ...
      >
        <Pressable
          ...
          onPress={handleNext}
        >
          <Text style={styles.btnNextText}>ADDITIONAL DETAILS →</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
